...
- **Cons:**
  ...
  - No concept of a namespaces in IDL
  - No tests or documentation
  - No clear path to contribute
:::
:::
::: {.column width="40%"}
![](static/ssw_screenshot.png)
:::
::::
...
::: {.r-stack}
![](static/ecosystem_animation/1_ecosystem_illustration.svg){.fragment width="2000px" fig-align="center"}

![](static/ecosystem_animation/2_ecosystem_illustration.svg){.fragment width="2000px" fig-align="center"}

![](static/ecosystem_animation/3_ecosystem_illustration.svg){.fragment width="2000px" fig-align="center"}

![](static/ecosystem_animation/4_ecosystem_illustration.svg){.fragment width="2000px" fig-align="center"}

![](static/ecosystem_animation/5_ecosystem_illustration.svg){.fragment width="2000px" fig-align="center"}
:::
